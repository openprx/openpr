...
- `../skills/openpr-mcp/scripts/mcp-regression.py` — 140-tool registry and core-surface regression test across HTTP, stdio, and SSE.
- `../skills/openpr-mcp/scripts/validate-mcp.sh` — Quick smoke test.

## 3. Source Code

- `../apps/api/` — REST API server (Axum + SeaORM).
- `../apps/mcp-server/` — MCP server (140 tools, HTTP/stdio/SSE).
