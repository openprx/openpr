...
contains "MCP registry expected count is 105" "apps/mcp-server/src/tools/mod.rs" "105,"
contains "MCP embedded skill guide exposes 105 tools" "apps/mcp-server/src/server.rs" "## Tools (105)"
...
contains "MCP AGENTS guide exposes 105 tools" "apps/mcp-server/AGENTS.md" "105 tools"
...
contains "MCP app README exposes 105 tools" "apps/mcp-server/README.md" "105 MCP Tools"
...
contains "MCP skill guide exposes 105 tools" "skills/openpr-mcp/SKILL.md" "enumerate all 105 tools"
...
contains "MCP skill validation requires exact 105 tools" "skills/openpr-mcp/scripts/validate-mcp.sh" "expected exactly 105 tools"
contains "MCP regression checks 105-tool registry" "skills/openpr-mcp/scripts/mcp-regression.py" "registry_has_105_tools_with_forms_and_plugins"
...
contains "docs index records current MCP tool count" "docs/README.md" "MCP server (105 tools"
contains "docs index records current MCP regression count" "docs/README.md" "105-tool registry"
...
contains "MCP test script defaults to current tool count" "scripts/test-mcp.sh" 'EXPECTED_TOOL_COUNT="${EXPECTED_TOOL_COUNT:-105}"'
