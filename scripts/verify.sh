...
echo "----------------------"
check "Compose .env file exists" "test -f .env" ""
check "API/worker config file exists" "test -f config/sylvode.compose.toml || test -f config/openpr.compose.toml" ""
check "MCP config file exists" "test -f config/sylvode.compose.mcp.toml || test -f config/openpr.compose.mcp.toml" ""
