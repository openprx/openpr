...
commands={
 ...
 "reference_embed":["cargo","test","-p","api","reference_embed_reauthorizes_forms_policy_and_missing_policy_is_read_only","--","--nocapture"],
 "conversion_fault_lineage":["cargo","test","-p","api","conversion_commit_rechecks_policy_and_is_idempotent_without_rewriting_source","--","--nocapture"],
 ...
 "forms_full":["cargo","test","-p","api","routes::form::","--","--nocapture"],
...
gates={
 ...
 "reference_and_unreference_policy":verdict('reference_embed','bridge_permission'),"embed_request_time_permission":verdict('reference_embed','bridge_permission'),
 ...
 "fault_injection_no_partial_bridge":verdict('conversion_fault_lineage'),"lineage_complete_no_double_write":verdict('conversion_fault_lineage'),
 "forms_gate_full_regression":verdict('forms_full'),"mcp_cli_bridge_equivalence":verdict('mcp_registry','mcp_policy','cli_bridge'),
 "tool_registry_expected_128_or_rebased":verdict('mcp_registry'),"bridge_event_registry_causation_and_redaction":verdict('reference_embed','conversion_fault_lineage')}
artifact_map={"bridge-contract-result.json":['reference_embed'],"embed-permission-result.json":['bridge_permission','reference_embed'],"conversion-fault-result.json":['conversion_fault_lineage'],"lineage-result.json":['conversion_fault_lineage'],"forms-regression-result.json":['forms_full']}
