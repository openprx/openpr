...
container_prefix_ok = bool(containers) and all(name.startswith("v09-openpr-rc-") for name in containers)
...
result = {
    ...
    "checks":checks, "containers":containers, "container_prefix":"v09-openpr-rc-",
