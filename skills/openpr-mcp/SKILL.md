...
```
tools/list                          → enumerate all 107 tools
...
- Regression test: `scripts/mcp-regression.py` — tests the core tool surface across 3 transports and checks the 107-tool registry includes universal forms, plugins, and Sylvode Flow
