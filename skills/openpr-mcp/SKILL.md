...
```
tools/list                          → enumerate all 119 tools
...
- Regression test: `scripts/mcp-regression.py` — tests the core tool surface across 3 transports and checks the 119-tool registry includes universal forms, plugins, and Sylvode Flow
